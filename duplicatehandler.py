...
class DuplicateHandler:
    ...
    def calcDiff(self, img1, img2):
        ...
        # bring the two images to the same size , corrected from original
        if img1.shape[0] > img2.shape[0] and img1.shape[1] < img2.shape[1]:
            img1 = img1[0: img2.shape[0], 0: img1.shape[1]]
            img2 = img2[0: img2.shape[0], 0: img1.shape[1]]

        elif img1.shape[0] < img2.shape[0] and img1.shape[1] > img2.shape[1]:
            img1 = img1[0: img1.shape[0], 0: img2.shape[1]]
            img2 = img2[0: img1.shape[0], 0: img2.shape[1]]

        elif img1.shape[0] > img2.shape[0] or img1.shape[1] > img2.shape[1]:
